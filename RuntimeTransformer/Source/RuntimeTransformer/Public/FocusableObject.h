...
public:
	...
	void Focus(class UTransformerComponent* Caller, class USceneComponent* Component, bool bComponentBased);

	
	//Unfocus is called right before the Component is removed from the list.
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Focusable")
	void Unfocus(class UTransformerComponent* Caller, class USceneComponent* Component, bool bComponentBased);
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Focusable")
	void OnNewTransformation(class UTransformerComponent* Caller, class USceneComponent* Component, const FTransform& NewTransform, bool bComponentBased);
